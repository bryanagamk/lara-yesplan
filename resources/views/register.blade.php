...
<div class="container ">
    <div class="p-4 d-flex flex-column justify-content-center">
        <h2 class="text-center">Daftar User Aplikasi</h2>
        <hr>
        @if(session('error'))
        ...
        <form action="{{ route('actionregister') }}" method="post">
            ...
            <div class="form-group mb-3">
                ...
                <input id="username" type="text" name="username" class="form-control mt-2" placeholder="Username" required>
            </div>
            <div class="form-group mb-3">
            ...
            <div class="form-group mb-3">
                ...
                <input id="role" type="text" name="role" class="form-control mt-2" placeholder="Role" required>
            </div>
